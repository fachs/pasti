				...
				<div class="card mt-3">
					<div class="is-scrollbar-hidden min-w-full overflow-x-auto">
						<table class="is-hoverable w-full text-left">
							<thead>
								<tr>
									<th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 lg:px-5"> Bidang </th>
									
									<th class="whitespace-nowrap rounded-tr-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 lg:px-5"> Aksi </th>
								</tr>
							</thead>
							<tbody> @foreach ($prokers as $proker) <tr class="border-y border-transparent border-b-slate-200">
								
								<td class="whitespace-nowrap px-4 py-3 sm:px-5">{{ $proker->nama_bidang }}</td>
								<td class="whitespace-nowrap px-4 py-3 sm:px-5">
									<a href="/keuangan/laporan/audit/{{ $proker->nama_bidang }}">
					...
					<div class="flex flex-col justify-between space-y-4 px-4 py-4 sm:flex-row sm:items-center sm:space-y-0 sm:px-5">
            			...
            			<ol class="pagination"> {!! $prokers->links() !!} </ol>
					</div>
				</div>
	</main>
</x-app-layout>