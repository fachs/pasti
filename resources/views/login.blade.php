<x-base-layout title="Dinkes Kota Sukabumi">
    <main class="grid w-1/2 grow grid-cols-1 place-items-center">
        <div class="w-1/2 max-w-[26rem] p-4 sm:px-5">
            <div class="text-center">
                <img class="mx-auto h-20 w-26 " src="{{ asset('images/app-logo.png') }}" alt="logo" />
                <div class="mt-4">
            ...
            <div class="mt-8 flex justify-center text-xs text-slate-400 dark:text-navy-300">
                <p>Sekretariat Dinas Kesehatan Kota Sukabumi 2025</p>
            </div>
        </div>
    </main>
</x-base-layout>
